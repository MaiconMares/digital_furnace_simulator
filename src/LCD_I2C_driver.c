...
/*
    I have to use -lwiringPi to compile this file and before that, I need to use gpio utility
    to load I2C drivers into Kernel: gpio load i2c
*/
#include <wiringPi.h>
...
void lcd_init(int file_descriptor)   {
  fd = file_descriptor;
